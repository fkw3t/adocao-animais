  ...
  <section class="perfil row d-flex justify-content-center my-5">
      ...
      <div class="container col-6 d-grid gap-2 d-md-flex justify-content-md-end my-5">
        ...
        <form action="" method="POST">
          @csrf
          <button class="btn btn-outline btn-lg me-md-2" type="submit">Meus Animais</button>
        </form>
        
        <form action="{{route('user.edit', ['user' => auth()->user()])}}" method="GET">
          @csrf
          <button class="btn btn-outline btn-lg me-md-2" type="submit">Editar Perfil</button>
        </form>
